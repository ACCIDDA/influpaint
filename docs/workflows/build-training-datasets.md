...
You will use **`influenza/2-build_training_flu_datasets_ipynb.py`** and the combined Parquet table to create **four NetCDF datasets of complete season images** for training.
